...
#pragma warning restore 0414
    ...
    public interface IAvatarAdapter
    {
        ...
        void setTargetUpVelocity(Vec3f vel);
        void setTargetRollVelocity(Vec3f vel);
        Vec3f getVelocity();
        Vec3f getTurnVelocity();
        Vec3f getUpVelocity();
        Vec3f getRollVelocity();
    }
    ...
    public class AvatarAdapterConnector
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        private delegate void setTargetUpVelocityCallBack(IntPtr vel);
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        private delegate void setTargetRollVelocityCallBack(IntPtr vel);
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        private delegate IntPtr getVelocityCallBack();
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        private delegate IntPtr getTurnVelocityCallBack();
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        private delegate IntPtr getUpVelocityCallBack();
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        private delegate IntPtr getRollVelocityCallBack();
        ...
        private setTargetUpVelocityCallBack _setTargetUpVelocityCallBack;
        private setTargetRollVelocityCallBack _setTargetRollVelocityCallBack;
        private getVelocityCallBack _getVelocityCallBack;
        private getTurnVelocityCallBack _getTurnVelocityCallBack;
        private getUpVelocityCallBack _getUpVelocityCallBack;
        private getRollVelocityCallBack _getRollVelocityCallBack;
#pragma warning disable 0414
        private object _setTargetVelocityCallBackBinder;
        private object _setTargetTurnVelocityCallBackBinder;
        private object _setTargetUpVelocityCallBackBinder;
        private object _setTargetRollVelocityCallBackBinder;
        private object _getVelocityCallBackBinder;
        private object _getTurnVelocityCallBackBinder;
        private object _getUpVelocityCallBackBinder;
        private object _getRollVelocityCallBackBinder;
#pragma warning restore 0414
        ...
        private void setTargetUpVelocity(IntPtr vel)
        {
            _impl.setTargetUpVelocity(new Vec3f(vel));
        }

        private void setTargetRollVelocity(IntPtr vel)
        {
            _impl.setTargetRollVelocity(new Vec3f(vel));
        }
        ...
        private IntPtr getUpVelocity()
        {
            return _impl.getUpVelocity().NativePtr();
        }

        private IntPtr getRollVelocity()
        {
            return _impl.getRollVelocity().NativePtr();
        }
        ...
        public AvatarAdapterConnector(IAvatarAdapter impl)
        {
            ...
            _setTargetUpVelocityCallBack = new setTargetUpVelocityCallBack(setTargetUpVelocity);
            Marshal.WriteIntPtr(PtrHelper.Add(vtblPtr, IntPtr.Size),
                PtrHelper.GetFunctionPointerForDelegate<setTargetUpVelocityCallBack>
                    (_setTargetUpVelocityCallBack, out _setTargetUpVelocityCallBackBinder));

            _setTargetRollVelocityCallBack = new setTargetRollVelocityCallBack(setTargetRollVelocity);
            Marshal.WriteIntPtr(PtrHelper.Add(vtblPtr, IntPtr.Size),
                PtrHelper.GetFunctionPointerForDelegate<setTargetRollVelocityCallBack>
                    (_setTargetRollVelocityCallBack, out _setTargetRollVelocityCallBackBinder));
            ...
            _getUpVelocityCallBack = new getUpVelocityCallBack(getUpVelocity);
            Marshal.WriteIntPtr(PtrHelper.Add(vtblPtr, IntPtr.Size * 3),
                PtrHelper.GetFunctionPointerForDelegate<getUpVelocityCallBack>
                    (_getUpVelocityCallBack, out _getUpVelocityCallBackBinder));

            _getRollVelocityCallBack = new getRollVelocityCallBack(getRollVelocity);
            Marshal.WriteIntPtr(PtrHelper.Add(vtblPtr, IntPtr.Size * 3),
                PtrHelper.GetFunctionPointerForDelegate<getRollVelocityCallBack>
                    (_getRollVelocityCallBack, out _getRollVelocityCallBackBinder));
        }
    }
    #endregion
    ...
    public class SimpleWiiTurnNavigationMediator : IDisposable
    {
        ...
        [DllImport("NavigationInterface.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void __swt_setTargetUpVelocity(IntPtr self, float targetUpVelocity);

        [DllImport("NavigationInterface.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void __swt_setTargetRollVelocity(IntPtr self, float targetRollVelocity);

        [DllImport("NavigationInterface.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern float __swt_getTargetTurnVelocity(IntPtr self);

        [DllImport("NavigationInterface.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern float __swt_getTargetUpVelocity(IntPtr self);

        [DllImport("NavigationInterface.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern float __swt_getTargetRollVelocity(IntPtr self);
        ...
        public void setTargetUpVelocity(float upVelocity)
        {
            __swt_setTargetUpVelocity(__nativePointer, upVelocity);
        }

        public void setTargetRollVelocity(float rollVelocity)
        {
            __swt_setTargetRollVelocity(__nativePointer, rollVelocity);
        }
        ...
        public float getTargetUpVelocity()
        {
            return __swt_getTargetUpVelocity(__nativePointer);
        }

        public float getTargetRollVelocity()
        {
            return __swt_getTargetRollVelocity(__nativePointer);
        }
