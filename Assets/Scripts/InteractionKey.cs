...
{    
    ...
    public bool GetButtonDown ( ConfigClass.Device device )
    {
        if ( device == ConfigClass.Device.Keyboard && ButtonMouse != MouseKey.None )
        {
            bool mouse;
    ...
    public string GetCurrentButton ( ConfigClass.Device device )
    {
        return GetCurrentButton ( device, "  /  " );
    }
 
 
    public string GetCurrentButton ( ConfigClass.Device device, string separator )
    {
        string button = "";
        ...
        switch ( device )
        {
            case ConfigClass.Device.Spacepilot:
                button = ButtonSpacepilot;
                break;
             
            case ConfigClass.Device.Xbox:
                button = ButtonXbox;
                break;
             
            case ConfigClass.Device.Keyboard:
